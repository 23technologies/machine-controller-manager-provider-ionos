...
if [[ "${SOURCE_PATH}" != *"src/github.com/23technologies/machine-controller-manager-provider-ionos" ]]; then
  SOURCE_SYMLINK_PATH="${SOURCE_PATH}/tmp/src/github.com/23technologies/machine-controller-manager-provider-ionos"
